...
#include "MaterialReporterPointSource.h"
#include "MooseUtils.h"

registerMooseObject("isopodApp", MaterialReporterPointSource);

InputParameters
MaterialReporterPointSource::validParams()
{
  ...
  params.addRequiredParam<MaterialPropertyName>(
      "source_property", "The name of the material property for the source term");
...
MaterialReporterPointSource::MaterialReporterPointSource(const InputParameters & parameters)
  : DiracKernel(parameters),
    ...
    _point(_read_in_points
               ...
               : _zeros_pts),
    _value(getMaterialProperty<Real>("source_property")),
...
void
MaterialReporterPointSource::addPoints()
{
...
Real
MaterialReporterPointSource::computeQpResidual()
{
